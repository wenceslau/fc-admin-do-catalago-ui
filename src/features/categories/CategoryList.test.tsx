...
describe("CategoryList", () => {
  ...
  //
  //   await waitFor(() => {
  //     const name = screen.getByText("Wenceslau Neto");
  //     expect(name).toBeInTheDocument();
  //   });
  //
  ...
  //
  //   await waitFor(() => {
  //     const name = screen.getByText("qwexcxcxcxcxe wertzzddd");
  //     expect(name).toBeInTheDocument();
  //   });
  // });
  ...
  //   // esperar que o elemento seja renderizado
  //   await waitFor(() => {
  //     const name = screen.getByText("qwee");
  //     expect(name).toBeInTheDocument();
  //   });
  ...
  //   fireEvent.change(input, { target: { value: "qwee" } });
  //
  //   await waitFor(() => {
  //     const loading = screen.getByRole("progressbar");
  //     expect(loading).toBeInTheDocument();
  ...
  //
  //   await waitFor(() => {
  //     const name = screen.getByText("qwee wert");
  //     expect(name).toBeInTheDocument();
  //   });
  //
